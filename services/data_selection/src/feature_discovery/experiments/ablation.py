...
from src.feature_discovery.experiments.evaluate_join_paths import evaluate_paths
...
def autofeat(
    ...
    all_results, top_k_paths = evaluate_paths(
        bfs_result=bfs_traversal, problem_type=dataset.dataset_type, algorithm=algorithm, fit_model=fit_model
    )
