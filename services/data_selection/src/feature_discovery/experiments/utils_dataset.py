...
from src.feature_discovery.experiments.dataset_object import CLASSIFICATION, REGRESSION, Dataset
from src.feature_discovery.experiments.init_datasets import CLASSIFICATION_DATASETS, REGRESSION_DATASETS, ALL_DATASETS


def filter_datasets(dataset_labels: Optional[List[str]] = None, problem_type: Optional[str] = None) -> List[Dataset]:
    print("all available datasets ", ALL_DATASETS)
    for dataset in ALL_DATASETS:
        print("dataset name: ", dataset.base_table_label)
