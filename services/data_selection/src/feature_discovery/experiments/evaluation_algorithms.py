...
from src.feature_discovery.config import AUTO_GLUON_FOLDER
from src.feature_discovery.experiments.dataset_object import REGRESSION
...
def evaluate_all_algorithms(dataframe: pd.DataFrame, target_column: str, algorithm: str, problem_type: str = 'binary', fit_model:bool = False):
